...
func main() {
	...
	maxParallelProcessors := flag.Int("parallel-processors", 8, "Maximum number of parallel message processors (CPU-bound).")
	maxParallelDownloaders := flag.Int("parallel-downloads", 4, "Maximum number of parallel attachment downloaders (I/O-bound).")
	...
	flag.Visit(func(f *flag.Flag) {
		...
		case "parallel-processors":
			cfg.MaxParallelProcessors = *maxParallelProcessors
		case "parallel-downloads":
			cfg.MaxParallelDownloaders = *maxParallelDownloaders
		case "api-rate":
